...
{
    public class InternoController : HController
    {
        // GET: Interno
        public ActionResult Index()
        {
            ...
            //Cria modelo p/ View
            InternoIndexModels model = new InternoIndexModels();
        ...
        public DataSet retornXMLToDataTable(string p)
        {
            DataSet ds = new DataSet();
            System.IO.StringReader xmlSR = new System.IO.StringReader(p);
